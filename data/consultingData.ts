      ...
      dropDownItems: [
        {
          ...
          info: `This document lays out the internal security policies of how the business uses, stores, and processes data. May include other policies such as Clean Desk, Remote Working, Responsible Parties, etc.`,
        },
        {
          title: "Disaster Recovery Plan",
          info: `Set of policies and procedures on how to enable the recovery of vital infrastructure and systems following a disaster. The important portion of this document should outline critical processes and how long each process can be down in order for your business to recover.`,
        },
        {
        ...
        },
        {
          ...
          info: "This document aims to guide the management of risk to support the achievement of corporate objectives.",
        },
      ],
    },
    {
      ...
      dropDownItems: [
        ...
        },
        {
          ...
          info: `We take a holistic approach to identifying and analyzing risks, to ensure your organization spends its time and money focusing on what matters most, protecting your clients, partners, and customers. This report provides invaluable feedback on your environment designed to help your environment work more effectively and safely, in ways that make sense for your business. This includes a holistic analysis of top cloud native risks, security by design, backup policy and strategy analysis.`,
        },
      ],
    },
  ],
