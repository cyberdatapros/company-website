...
export const studyArray: CaseStudy[] = [
...

  {
    ...
    result: `Inbox Monster, recently completed Stage 1 and Stage 2 audits for ISO 27001 certification. The audits were a resounding success, thanks in large part to the assistance provided by CyberData Pros! As a result of their successful audits, Inbox Monster has been awarded the ISO 27001 certificate. This certification confirms that the company has established a systematic approach to managing  and protecting information assets, including customer data, intellectual  property, and sensitive information. The achievement of ISO 27001 certification further enhances Inbox Monster's reputation for providing secure and reliable email management solutions.`,
    testimonial: `"With CDP, Inbox Monster gained a partner whose commitment to a successful process and full certification was apparent from the beginning. CDP was our co-pilot throughout the process and we would not have achieved certification without their experience."`,
    clientName: "Matt McFee",
    clientTitle: "Managing Partner at Inbox Monster",
  },
