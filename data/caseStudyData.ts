...
export const studyArray: CaseStudy[] = [
  {
    ...
    problem:
      "Onwards HR faced a significant challenge in responding to security questionnaires received from their clients. On top of uncertainty on how to address these questionnaires, they also needed improved security measures and compliance. This prompted them to seek expert guidance from CyberData Pros. Additionally, they aspired to obtain SOC 2 certification, all while exploring the idea of global expansion while ensuring security at every step.",
    solution: `<p>Onwards HR partnered with CyberData Pros, which specializes in data privacy, security, and compliance to serve as their virtual Chief Information Security Officer (vCISO). The collaboration aimed to address the few challenges faced by Onwards HR:</p><p><br></p><p><strong>Security Questionnaires:</strong> CyberData Pros assisted Onwards HR in understanding and responding to security questionnaires from clients, ensuring accurate and comprehensive answers.</p><p><br></p><p><strong>SOC 2 Certification</strong>: The vCISO played a crucial role in guiding Onwards HR through the SOC 2 certification process, helping them meet the stringent security and compliance requirements.</p><p><br></p><p><strong>Policy Revisions:</strong> CyberData Pros provided ongoing support for updating and revising policies to align with the latest industry standards and compliance regulations.</p><p><br></p><p><strong>Security Implementations:</strong> Recommendations for security implementations were offered, ensuring Onwards HR's platform was protected against potential threats and vulnerabilities.</p><p><br></p><p><strong>Global Expansion: </strong>Onwards HR received guidance on secure global expansion, addressing considerations for entering new markets such as the UK, Canada, the Middle East, and China.</p>`,
    testimonial: `<p>"There are so many cybersecurity rules and data regulations, which can be especially overwhelming for people who don’t specialize in the industry. Having to answer security questionnaires when you’re not the expert alongside your main responsibilities was not scalable. In addition, we needed guidance on how to grow globally AND securely. Find an expert in this area with whom you can partner!! This was a game-changer for us. It not only helped us scale but gave us peace of mind that we were compliant and most of all that our customers’ data was safe. Your responsiveness and attention to detail are incomparable. You were always a slack away and we knew we count on you. It was like we were your only customer!"</p><p><br></p><p><strong>Co-Founder, Chief Product Officer at OnwardsHR</strong></p><p><strong>Janice Edwards</strong></p>`,
    result: `<p>The partnership with CyberData Pros gained significant positive outcomes for Onwards HR:</p><p><br></p><p><strong>SOC 2 Certification:</strong> Onwards HR successfully obtained SOC 2 certification, validating their commitment to data security and compliance.</p><p><br></p><p><strong>Client Acquisition:</strong> Onwards HR found that the smooth completion of client questionnaires made it easier for them to bring in new clients. This not only boosted confidence in the company's security practices but also helped strengthen their client base.</p><p><br></p><p><strong>Gap Remediation</strong>: CyberData Pros helped Onwards HR identify and remediate security gaps, ensuring a strong and secure platform.</p><p><br></p><p>Continuous Compliance: Through ongoing support and policy revisions, Onwards HR remains up-to-date with the latest privacy trends and compliance requirements.</p><p><br></p><p><strong>Global Presence: </strong>With the help of CyberData Pros' advice, Onwards HR can confidently expand into global markets, ensuring secure operations across diverse geographical regions.</p>`,
  },

  {
    ...
    testimonial: `<p>"Cyberdata Pros led Inbox Monster's ISO27001 planning and preparation. CDP was an essential partner, and we would not have been able to properly prepare for our audits without their guidance."</span></p><p><br></p><p><strong>Matt McFee</strong></p><p><strong>Managing Partner at Inbox Monster</strong></p>`,
  },

  {
    ...
    testimonial: `<p>"As a result of Cyberdata Pros' help, HLD is now well-positioned to meet the challenges of the evolving privacy landscape and to protect the privacy of its users."</p><p>﻿</p><p> <strong>Vice</strong> <strong>President of Marketing at HealthLink Dimensions</strong></p><p><strong>-Nathan Lenyszyn</strong></p>`,
  },
];
